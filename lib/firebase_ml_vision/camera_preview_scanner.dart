  ...
  Widget _buildResults() {
    ...
    switch (_currentDetector) {
      case Detector.barcode:
        ...
        painter = BarcodeDetectorPainter(imageSize, _scanResults as List<Barcode>);
        break;
      case Detector.face:
      ...
      case Detector.label:
        ...
        painter = LabelDetectorPainter(imageSize, _scanResults as List<ImageLabel>);
        break;
      case Detector.cloudLabel:
        if (_scanResults is! List<ImageLabel>) return noResultsText;
        painter = LabelDetectorPainter(imageSize, _scanResults as List<ImageLabel>);
      ...
      default:
        ...
        painter = TextDetectorPainter(imageSize, _scanResults as VisionText);
    }
