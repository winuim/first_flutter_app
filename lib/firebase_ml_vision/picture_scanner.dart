...
class _PictureScannerState extends State<PictureScanner> {
  ...
  CustomPaint _buildResults(Size imageSize, dynamic results) {
    ...
    switch (_currentDetector) {
      case Detector.barcode:
        painter = BarcodeDetectorPainter(_imageSize, results as List<Barcode>);
        break;
      case Detector.face:
        painter = FaceDetectorPainter(_imageSize, results as List<Face>);
        break;
      case Detector.label:
        painter = LabelDetectorPainter(_imageSize, results as List<ImageLabel>);
        break;
      case Detector.cloudLabel:
        painter = LabelDetectorPainter(_imageSize, results as List<ImageLabel>);
        break;
      case Detector.text:
        painter = TextDetectorPainter(_imageSize, results as VisionText);
        break;
      case Detector.cloudText:
        painter = TextDetectorPainter(_imageSize, results as VisionText);
        break;
